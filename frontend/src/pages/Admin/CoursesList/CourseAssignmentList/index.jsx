          ...
          >
            ...
            <Tooltip title="Submission">
              <IconButton
                ...
                onClick={() => {
                  navigate(`/admin/courses/assignment/${assignment.id}/submissions`);
                }}
              >
                <AssignmentIndIcon />
              </IconButton>
            ...
            <Tooltip title="View Assignment">
              <IconButton
                ...
                color="primary"
                onClick={() => {
                  navigate(`/admin/problems/${assignment.problem_id}`);
                }}
              >
                <VisibilityOutlined />
              </IconButton>
...
export default AssignmentCoursesList;
